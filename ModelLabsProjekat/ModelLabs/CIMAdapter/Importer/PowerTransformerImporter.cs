...
namespace FTN.ESI.SIMES.CIM.CIMAdapter.Importer
{
	...
	public class PowerTransformerImporter
	{
		...
		private void ConvertModelAndPopulateDelta()
		{
            ...
            //DODATI SVOJE METODE IZ IMPORT REGIONA DOLE ZA KONKRETNE KLASE
        ...
        private void ImportACLineSegments()
        {
            ...
            {
                foreach (KeyValuePair<string, object> cimBaseVoltagePair in cimACLineSegments)
                {
                    FTN.ACLineSegment cimACLineSegment = cimBaseVoltagePair.Value as FTN.ACLineSegment;
        ...
        private void ImportTerminals()
        {
            ...
            {
                foreach (KeyValuePair<string, object> cimBaseVoltagePair in cimTerminals)
                {
                    FTN.Terminal cimTerminal = cimBaseVoltagePair.Value as FTN.Terminal;
